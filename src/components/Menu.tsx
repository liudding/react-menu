...
import { ControllerContext } from "../hooks/useControllerContext";
...
export interface MenuProps
  ...
  /**
   * If true, the focused item will be added a `focused` class
   */
...
export const Menu: React.FC<MenuProps> = ({
  ...
  function show({ event, props, position }: ShowContextMenuParams) {
    ...
    const p = position || (event && getMousePosition(event));
    if (!p) throw new Error("No position provided");
  ...
  return (
    <ControllerContext.Provider value={menuController}>
